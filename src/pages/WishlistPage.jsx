    ...
    <main className="flex-grow pt-20 md:pt-28 pb-20 md:pb-24 px-4 md:px-6 lg:px-8 max-w-7xl mx-auto w-full font-['Inter'] antialiased">
      ...
      {wishlistData.length === 0 ? (
        <div className="text-center py-12 md:py-20">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-[#002629] mb-2 md:mb-3 font-['Manrope']">Your wishlist is empty</h2>
        ...
        <div className="text-center py-12 md:py-20">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-[#002629] mb-2 md:mb-3 font-['Manrope']">No matching books found</h2>
          <p className="text-[#404849] mb-6 md:mb-8 max-w-md mx-auto text-sm md:text-base px-4">
                  ...
                  <div className="p-5 flex flex-col flex-grow">
                    ...
                    <div className="mt-auto">
                      ...
                      <div className="flex items-center justify-between mb-2 md:mb-3">
                        <span className="text-base md:text-lg font-extrabold text-[#002629]">{formatPrice(book.price)}</span>
                      ...
                      <button 
                        ...
                        className="w-full py-2 md:py-2.5 bg-[#002629] text-white rounded-lg text-xs md:text-sm font-semibold flex items-center justify-center gap-1.5 md:gap-2 transition-all hover:bg-[#083d41] active:scale-[0.98]"
                      >
